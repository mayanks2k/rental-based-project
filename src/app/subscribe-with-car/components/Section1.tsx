  ...
  return (
    <div className="py-10 px-2">
      ...
      <div className="flex justify-center items-center">
        <Link href={'/subscribe-with-car/benefits'} className="bg-gradient-to-r mt-10 from-green-600 to-blue-600 text-white text-center px-6 py-2 rounded-full text-xl">
          View All Benefits
        </Link>
      </div>
    </div>
